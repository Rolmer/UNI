...
*/
  ...
  if (client.connect(server,80)>0) {  // Se conecta al servidor
    client.print("GET /WAPOSAT3/Template/InsertData.php?sensor1=1&equipo=2&sensor2=2&valor1="); // Envia los datos utilizando GET
...
float T;              //the final temperature is stored here
...
T= 0.0512 * v_out -20.5128; //the equation from millivolts to temperature
return T;             //send back the temp
}
//---------------------------------------------------------------------------------------------------------------------
